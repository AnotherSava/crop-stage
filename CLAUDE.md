...
- **Config + state**: `config.json` (shipped, user-tweakable hotkeys/colors) and `state.json` (runtime per-user state — last-used frame dimensions, folder, filename, and tray preferences like "Hide with Esc") both live next to the exe.
